<%@ Page Title="tb_供应商信息_附件" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="gzpi.Web.tb_供应商信息_附件.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="文件名" HeaderText="文件名" SortExpression="文件名" ItemStyle-HorizontalAlign="Center"  /> 
